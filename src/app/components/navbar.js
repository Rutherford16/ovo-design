...
export default function Navbar() {
    return (
        <nav className='w-full lg:w-2/5 px-5 fixed bottom-0 flex justify-between bg-white'>
            ...
            <Link href='/' className='flex flex-col items-center p-1 static w-16'>
            ...
            <Link href='/settings' className='flex flex-col items-center p-1 hover:opacity-70'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
